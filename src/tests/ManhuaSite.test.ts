...
import { BuddyComplex } from '../BuddyComplex'
import { ManhuaSite } from '../ManhuaSite/ManhuaSite'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ManhuaSite Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: BuddyComplex = new ManhuaSite(cheerio)
   ...
   */
    const mangaId = 'divine-soul-emperor' // divine-soul-emperor
    ...
    it('Testing home page results for popular titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'top_today', {}, 1)
