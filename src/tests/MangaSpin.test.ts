...
import { MangaSpin } from '../MangaSpin/MangaSpin'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MangaSpin Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: BuddyComplex = new MangaSpin(cheerio)
   ...
   */
    const mangaId = 'the-scholar-warrior' // the-scholar-warrior
