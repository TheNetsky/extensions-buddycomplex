...
import { MangaFab } from '../MangaFab/MangaFab'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MangaFab Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: BuddyComplex = new MangaFab(cheerio)
   ...
   */
    const mangaId = 'beyond-myriad-peoples' // beyond-myriad-peoples
