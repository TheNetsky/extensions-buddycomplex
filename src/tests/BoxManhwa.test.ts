...
import { BoxManhwa } from '../BoxManhwa/BoxManhwa'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('BoxManhwa Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: BuddyComplex = new BoxManhwa(cheerio)
   ...
   */
    const mangaId = 'beast-with-flowers' // beast-with-flowers
