...
describe('MangaBuddy Tests', () => {
    const wrapper = new paperback_extensions_common_1.APIWrapper();
    const source = new MangaBuddy_1.MangaBuddy(cheerio_1.default);
   ...
   */
    ...
    it('Testing home page results for popular titles', () => __awaiter(void 0, void 0, void 0, function* () {
        const results = yield wrapper.getViewMoreItems(source, 'top_today', {}, 1);
